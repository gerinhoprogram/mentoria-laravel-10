...
<div>
    <form action="{{route('usuario.index')}}" method="get">
        ...
        <a href="{{route('cadastrar.usuario')}}" type="button" class="btn btn-success float-end">Incluir usuarios</a>
    </form>
        ...
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$usuario->email}}</td>
                    <td>
                        <a href="{{route('atualizar.usuario', $usuario->id)}}" class="btn btn-warning btn-sm">
                            Editar 
                        </a>
